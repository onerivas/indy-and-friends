      ...
      <Carousel className="w-75 mx-auto">
        <Carousel.Item>
          ...
          <div className="carCap">
            ...
            <p className="text">
              {" "}
              Click through and check out all our friends!!!
            </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <div className="carCap">
            ...
            <p className="text">
              Our friends on one of our trips to the beach!
            </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <div className="carCap">
            ...
            <p className="text">
              {" "}
              Taking a break under a tree during one of his visits
            </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <div className="carCap">
            ...
            <p className="text">
              {" "}
              She was trying to hide but we were about to get a good photo of
              her.{" "}
            </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <div className="carCap">
            ...
            <p className="text">
              {" "}
              Waiting for a drink at the sink. He loves it!!!{" "}
            </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <div className="carCap">
            <h3>Maggie</h3>
            <p className="text"> She was a good girl, posing for a photo </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          <div className="d-flex justify-content-center">
        ...
        <Carousel.Item>
          ...
          <div className="carCap">
            ...
            <p className="text">
              {" "}
              She looked so cute we had to take a photo!!!{" "}
            </p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
